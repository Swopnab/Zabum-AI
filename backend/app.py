...
def process_image():
    ...
    try:
        ...
        # TODO: Week 1 - Implement OCR service
        # extracted_text = ocr_service.extract_text(filepath)
        extracted_text = "[OCR will be implemented in Week 1]"
        
        # TODO: Week 2 - Implement LLM tagging
        # metadata = llm_service.generate_metadata(extracted_text)
        tags = ["placeholder", "week2"]
        summary = "This will be generated by LLM in Week 2"
        category = "other"
        
        # TODO: Week 1 - Save to database
...
def get_images():
    ...
    """
    # TODO: Week 1 - Fetch from database
    return jsonify({
        'images': [],
        'count': 0,
        'message': 'Database integration coming in Week 1'
    })
